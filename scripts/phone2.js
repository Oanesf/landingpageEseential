document.addEventListener("DOMContentLoaded", () => {
  ...
  const screenMedia = [
    "videos/bajacalidad2.mp4", // Video for section 1
    "images/chat2.webp", // Image for section 2
    "images/date2.webp", // Image for section 3
    "images/home1.webp", // Image for section 4
    "images/home1.webp", // Image for section 5
  ]
...
function alHacerScroll2() {
  // Hide element if target section is visible
  if (esVisible2(seccionObjetivo2)) {
...
// Add scroll event listener
window.addEventListener('scroll', alHacerScroll2);
